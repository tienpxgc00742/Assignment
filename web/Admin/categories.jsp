      ...
      <ul class="collapsible popout" data-collapsible="accordion">
           ...
           <li style="margin: 0 0 3px 0;">
            ...
            <div class="collapsible-body" style="display: none;margin-left: 12px;">
             ...
             <c:forEach var="sc" items="${result.rows}">
                 <div class="section">
                  <input id='input_text' class="subinput" type='text' value='${sc.SubCategoryName}' readonly='true'/>
                 </div>
             </c:forEach>
             <button class="btn" type="submit" name="action" onclick="alert()" style="float: right;margin-right: 10px;margin-bottom: 10px">
       ...
       <script>
           jQuery(document).ready(function ($) {
                jQuery('.section').onclick(function () {
                    alert('123');
                     jQuery(this).html("<input id='input_text' type='text' value="A">");

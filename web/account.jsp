                ...
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                 <div class="col-main">
                  <script type="text/javascript">
                    ...
                    <c:if test="${param.reresponse eq 'success'}">
                        <ul class="messages"><li class="success-msg"><ul><li><span>Thank you for registering with Main Website Store.</span></li></ul></li></ul>   
                           </c:if>
                    <div class="welcome-msg">
                     <p class="hello"><strong>Hello, ${sessionScope['6c6f67696e75736572']}!</strong></p>
                     ...
                     <div class="col-1">
                      <div class="box">
                       ...
                       <div class="box-content">
                        <p>
                         <sql:query var="account" dataSource="${conn}">
                             SELECT * FROM wAccount WHERE [user] = ?
                             <sql:param value="${sessionScope['6c6f67696e75736572']}"/>
                         </sql:query>
                         <img src="./images/${account.rows[0].avatar}" width="100" height="100"/><br/><br/>
                         ${account.rows[0].name}<br>

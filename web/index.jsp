   ...
   <div class="main">
          ...
          <li class="item last item-animate">
           <div class="item-inner">
            ...
            <div class="product-shop">
             ...
             <div class="actions">
              <button type="button" id="fukcing" class="button btn-cart" value="${p.ProductID}" data-original-title="Add to Cart" rel="tooltip"><span><span><i class="fa fa-shopping-cart"></i>Add to Cart</span></span>
              </button>
    ...
    <script>
     jQuery('.btn-cart').click(function () {
      var href = "cart.jsp?productid=" + jQuery(this).val();
